...
public class ShootFragment extends Fragment {
    ...
    private void setActionbar(){
        ...
        if(actionBar != null){
            actionBar.setDisplayHomeAsUpEnabled(true);//��ʾ����ͼ��
            actionBar.setDisplayShowHomeEnabled(false);//��ʾappͼ��
            actionBar.setTitle(getActivity().getResources().getString(R.string.activity_title_shoot));
        }
    }
    ...
    private static void checkIfEnabled() {
        Runnable requestThread = new Runnable(){
            ...
            public void run() {
                ...
                String api = "http://" + Config.address + ":" + Config.port + Config.getPhoneEnableAPI;
                String result = HttpRequest.sendPost(api, param);
                if (result.equals("0")) {
                    Message statusmsg = new Message();
...
//            ����豸�Ƿ�ע��
            if (msg.what == NOT_REGISTER) {
                ...
                shootButton.setVisibility(View.GONE);
                statusText.setText(mActivity.get().getResources().getString(R.string.shoot_not_register));
...
//            �豸δ�������㹦��
                ...
                statusText.setVisibility(View.VISIBLE);
                shootButton.setVisibility(View.GONE);
                statusText.setText(mActivity.get().getResources().getString(R.string.shoot_disabled));
            }
//           �豸�ѿ������㹦��
//            ����record��ť shootButton.setVisibility(View.VISIBLE)
...
//                intent.putExtra("manage_port", device.get("server_port"));
                ...
                statusText.setVisibility(View.VISIBLE);
                shootButton.setVisibility(View.GONE);
                statusText.setText(mActivity.get().getResources().getString(R.string.shoot_error));
            }
        }
    }
}
